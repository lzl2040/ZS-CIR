...
def log_to_file(data, metrics, checkpoint_name, file_path, fiq_data_type=None, orc_replace_text=False):
    if data == 'flickr30k' or data == 'coco':
        ...
        r_at_1, r_at_3, r_at_5, r_at_50 = metrics
        output = f"{data}:  R@1: {r_at_1:.4f} R@5: {r_at_3:.4f} R@10: {r_at_5:.4f} R@50: {r_at_50:.4f}"
...
def cir(model, transform,
    ...
    if data == 'fashioniq':
        ...
        r_at_50 = cir_recall_at_k(scores, labels, 50)
        metrics = [r_at_1, r_at_3, r_at_5, r_at_50]
    ...
    for data in datasets:
        ...
        if accelerator.is_main_process:
            ...
            if data == 'cirrtest':
                ...
                all_results.append(log_to_file(data, metrics, checkpoint_name, file_path, fiq_data_type=fiq_data_type, orc_replace_text=ocr_replace_text))
